import { EntryPointSimulations__factory, type IEntryPointSimulations } from '../typechain';
import { packUserOp, type UserOperation } from './ERC4337Utils';
...
export function decodeSimulateHandleOpResult(data: string): SimulateHandleUpResult {
  return entryPointSimulationsInterface.decodeFunctionResult(
    'simulateHandleOp',
    data,
  )[0] as SimulateHandleUpResult;
}
